...
class LugaresSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('tbl_lugares')->insert([
            ['nombre' => 'La Flama',                                                        'descripcion' => 'Cervecería y restaurante con variadas tapas y menú del día, en dos plantas con salones para celebraciones.',          'direccion_completa' => 'Rambla de la Marina, 150, 08907 L Hospitalet de Llobregat, Barcelona',                  'latitud' => 41.35166796853979, 'longitud' => 2.1114775848600256, 'icono' => null, 'imagen' => null, 'id_categoria' => 1],
        ...
        DB::table('tbl_lugares')->insert([
            ...
            ['nombre' => 'Institut Can Vilumara',             'descripcion' => 'Instituto de educación secundaria histórico.',   'direccion_completa' => 'Avinguda de Josep Tarradellas i Joan, 153',                               'latitud' => 41.3631625881294, 'longitud' => 2.104042511074963, 'icono' => null, 'imagen' => null, 'id_categoria' => 2],
            ['nombre' => 'Escola Tecla Sala',                 'descripcion' => 'Escuela cristiana concertada.',                 'direccion_completa' => 'Carrer de Tecla Sala, 10',                                                 'latitud' => 41.36062681519767, 'longitud' => 2.0984355120272244, 'icono' => null, 'imagen' => null, 'id_categoria' => 2],
        ...
        DB::table('tbl_lugares')->insert([
            ...
            ['nombre' => 'Tamoil',                       'descripcion' => 'Servicio rápido y eficiente.',           'direccion_completa' => 'Carrer Juan Ramón Jiménez, 20, 08902 L Hospitalet de Llobregat, Barcelona',             'latitud' => 41.36160398995726, 'longitud' => 2.117757295279628, 'icono' => null, 'imagen' => null, 'id_categoria' => 3],
        ]);
        ...
        DB::table('tbl_lugares')->insert([
            ...
            ['nombre' => 'CAP Amadeu Torner',                     'descripcion' => 'Centro de atención primaria.',           'direccion_completa' => 'Carrer d Amadeu Torner, 63, 08902 L Hospitalet de Llobregat, Barcelona',                      'latitud' => 41.3604847725776, 'longitud' => 2.1225070848849583, 'icono' => null, 'imagen' => null, 'id_categoria' => 5],
